...
class ConversationToLanguage extends StatefulWidget {
  ...
  @override
  State<ConversationToLanguage> createState() => _ConversationToLanguageState();
}

class _ConversationToLanguageState extends State<ConversationToLanguage> {
                  ...
                  child: GestureDetector(
                    onTap: () {
                      BlocProvider.of<ConversationBloc>(context)
                          .add(ConversationSetTo(listOfCountry[index]));
                      Navigator.pop(context);
                    },
                    child: Container(
                      height: 70,
